...
Read multi-channel differential data using an mbed K64F board with a Mikroe ADC 18 Click board. A library file is included to simultaneously read encoder data with QEI.
