...
const NeedleController::ComMessage NeedleController::comMessages[] = {
    ...
    {FID_GET_ALL_SENSOR_DATA_CONTINUOUS, (NeedleController::messageHandlerFunc)&NeedleController::getAllSensorDataContinuous},
...
void NeedleController::getAllSensorData(const MessageHeader* data) { 
    ...
    // threadFT->start(callback(this, &NeedleController::getFTDataThread));
...
void NeedleController::getAllSensorDataContinuous(const Settings* data) { 
    static AllDataMessage allDataMessage;
    allDataMessage.header.packetLength = sizeof(allDataMessage);
    allDataMessage.header.fid = FID_GET_ALL_SENSOR_DATA;
    clearAllData(&allDataMessage.allData);
    ...
    allDataMessage.allData.adcData_6Channel = _adc18_FT.getADCData_6Channel_continuous(data->value);
...
void NeedleController::streamData() {
    ...
    for (int i = 0; i < samplesToAverage; ++i) {
        ...
        _adcData_6Channel = _adc18_FT.getADCData_6Channel_continuous(3);
