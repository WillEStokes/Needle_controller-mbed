...
#define ADC18_CONV_MODE_CONTINUOUS          0x00 // Fast rate, low accuracy
...
class ADC18
{
    public:
        ...
        ADC18::ADCData_6Channel getADCData_6Channel_continuous(uint8_t samplesToAverage);
        float read_ADC_18(uint8_t channel);
        void ready_interrupt();
        void check_num_samples();
        bool check_ready_pin();
